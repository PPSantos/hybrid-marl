...
## Run example (this is the only env. that is registered):
```sh
python3 src/main.py --config=qmix --env-config=gymma with env_args.time_limit=500 env_args.key="Foraging-8x8-2p-1f-coop-v2"
```
